...
namespace Modul7
{
	 ...
	 * Самым главным будет класс Заказ Order
	 * 
	 * В него будет включено
	 *  - Способ доставки товара 
	 *  - Клиент, который получает товар
	 *  - Сотрудник, который доставляет товар. Экспедитор, участвует в любой доставке.
	 *  - Продукт как отдельный объект
	 *  - Массив объектов Продуктов в заказе
	 * 
	 *  Структрура классов "людей". Сотрудников, Клиентов.
	 *  Структура классов товаров. Допущение, что торгуем Овощами, Фруктами, Ягодами.
	 *  Структура классов доставки.
	 *  
	 */
